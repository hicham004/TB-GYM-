    ...
    : ICheckInResponseApplicationService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return access.Status != CheckInCommandStatus.Success
            ? Denied(access)
            : await ReadAsync(access.ClientProfileId, assignmentId, cancellationToken);
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            return await SuccessAsync(access.ClientProfileId, assignmentId, cancellationToken);
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return context is null
            ...
            : new CheckInResponseCommandResult(CheckInCommandStatus.Success, ToDetail(context));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await ReadAsync(clientProfileId, assignmentId, cancellationToken);
    }
    ...
    private static CheckInResponseDetail ToDetail(ResponseContext context)
    {
        ...
        return new CheckInResponseDetail(
            ...
            context.Response is null
                ? null
                : CheckInViewFactory.Response(context.Response, context.Assignment.DueDate, questions));
    }
